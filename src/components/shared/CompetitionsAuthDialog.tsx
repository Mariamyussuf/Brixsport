...
export const CompetitionsAuthDialog: React.FC<CompetitionsAuthDialogProps> = ({ isOpen, onClose, onDemoAccount }) => {
  ...
  return (
    <Dialog isOpen={isOpen} onClose={onClose} title="Competitions Access">
      <p className="mb-6">You need to sign in to use Competitions. Sign in or continue with demo account.</p>
